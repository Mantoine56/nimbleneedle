...
// Client-only home page component extracted from app/page.tsx so that
// the route file can export page-level metadata while this component
// handles all client-side state, effects, and UI logic.
