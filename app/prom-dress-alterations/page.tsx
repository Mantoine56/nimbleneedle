...
const serviceOptions = [
  {
    ...
    description: "Not sure about fit or alterations needed? Our experts can assess your dress and recommend the best alterations!"
  },
  {
    icon: Diamond,
    title: "I need it done right",
    description: "We specialize in formal wear and understand how important your prom night is. Perfect results guaranteed."
  },
  {
    icon: Zap,
    title: "I have an urgent need",
    description: "Prom coming up soon? We offer rush services to ensure your dress is ready for your special night!"
  }
];

export default function PromDressAlterationsPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Prom Dress Alterations', current: true }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`transition-all duration-1000 ${
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 font-league-spartan">
                Looking for prom dress alterations to get a perfect fit?
              </h2>
              
              <p className="text-lg text-gray-600 mb-8 font-montserrat">
                Make your prom night unforgettable with professional dress alterations. 
                Our experienced seamstresses ensure your dress fits perfectly and makes you feel confident and beautiful.
              </p>
