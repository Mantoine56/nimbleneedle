...
const serviceOptions = [
  {
    ...
    description: "Not sure what alterations are needed for your dress or skirt? Our experts can assess and recommend the best adjustments!"
  },
  {
    icon: Diamond,
    title: "I need it done right",
    description: "We specialize in dress and skirt alterations with attention to detail and perfect finishing."
  },
  {
    icon: Zap,
    title: "I have an urgent need",
    description: "Need your dress or skirt altered for a special event? We offer rush services to meet your timeline!"
  }
];

export default function DressSkirtAlterationsPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Dress and Skirt Alterations', current: true }
  ];
