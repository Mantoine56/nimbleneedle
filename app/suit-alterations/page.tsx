...
const serviceOptions = [
  {
    ...
    description: "Not sure what alterations your suit needs? Our experts can assess the fit and recommend the best adjustments!"
  },
  {
    icon: Diamond,
    title: "I need it done right",
    description: "We specialize in suit alterations with precision tailoring to ensure the perfect professional fit."
  },
  {
    icon: Zap,
    title: "I have an urgent need",
    description: "Need your suit altered for an important meeting or event? We offer rush services to meet your deadline!"
  }
];

export default function SuitAlterationsPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Suit Alterations', current: true }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`transition-all duration-1000 ${
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 font-league-spartan">
                Looking for suit alterations to get a perfect fit?
              </h2>
              
              <p className="text-lg text-gray-600 mb-8 font-montserrat">
                Get the perfect fit for your business suits, formal wear, and special occasion attire. 
                Our expert tailors ensure your suits fit like they were custom-made for you.
              </p>
