...
const serviceFeatures = [
  "Perfect Fit for All Shirts",
  "Sleeve Length Adjustments", 
  "Body & Collar Alterations",
...
const serviceOptions = [
  {
    ...
    description: "Not sure what alterations your shirt needs? Our experts can assess the fit and recommend the best adjustments!"
  },
  {
    icon: Diamond,
    title: "I need it done right",
    description: "We specialize in shirt alterations with precision tailoring for dress shirts, casual shirts, and blouses."
  },
  {
    icon: Zap,
    title: "I have an urgent need",
    description: "Need your shirt altered for work or an event? We offer rush services to meet your timeline!"
  }
];

export default function ShirtAlterationsPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Shirt Alterations', current: true }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`transition-all duration-1000 ${
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 font-league-spartan">
                Looking for shirt alterations to get a perfect fit?
              </h2>
              
              <p className="text-lg text-gray-600 mb-8 font-montserrat">
                Get the perfect fit for your dress shirts, casual shirts, and blouses. 
                Our skilled seamstresses ensure your shirts look polished and feel comfortable all day long.
              </p>
