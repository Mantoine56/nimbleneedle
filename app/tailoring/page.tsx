...
const serviceOptions = [
  {
    ...
    description: "Not sure where to start or what changes would be best? Our friendly staff can provide options for you!"
  },
  {
    icon: Diamond,
    title: "I need it done right",
    description: "Our experts work with all fabrics and styles. We can get the results you're looking for and with up-front pricing."
  },
  {
    icon: Zap,
    title: "I have an urgent need",
    description: "Talk to us. We've done magic for many customers and will do our best to help you!"
  }
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`transition-all duration-1000 ${
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 font-playfair">
                Looking for a tailor to get a perfect fit?
              </h2>
