...
const serviceFeatures = [
  "Perfect Fit for All Jackets",
  "Sleeve Length Adjustments", 
  "Body & Waist Tailoring",
...
const serviceOptions = [
  {
    ...
    description: "Not sure what alterations your jacket needs? Our experts can assess the fit and recommend the best adjustments!"
  },
  {
    icon: Diamond,
    title: "I need it done right",
    description: "We specialize in jacket alterations with precision tailoring for blazers, coats, and formal jackets."
  },
  {
    icon: Zap,
    title: "I have an urgent need",
    description: "Need your jacket altered for a business meeting or event? We offer rush services to meet your timeline!"
  }
];

export default function JacketAlterationsPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Jacket Alterations', current: true }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`transition-all duration-1000 ${
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 font-playfair">
                Looking for jacket alterations to get a perfect fit?
              </h2>
              
              <p className="text-lg text-gray-600 mb-8 font-montserrat">
                Get the perfect fit for your blazers, suit jackets, coats, and formal wear. 
                Our skilled tailors ensure your jackets look sharp and feel comfortable for any occasion.
              </p>
