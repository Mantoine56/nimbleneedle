...
const serviceOptions = [
  {
    ...
    description: "Not sure what alterations are possible? Our skilled seamstresses can assess your garment and provide expert advice!"
  },
  {
    icon: Diamond,
    title: "I need it done right",
    description: "Our professional seamstresses have years of experience working with all types of fabrics and garments."
  },
  {
    icon: Zap,
    title: "I have an urgent need",
    description: "Need alterations done quickly? We offer rush services to meet your timeline!"
  }
];

export default function SeamstressServicesPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Seamstress Services', current: true }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`transition-all duration-1000 ${
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 font-league-spartan">
                Looking for a seamstress service to get a perfect fit?
              </h2>
              
              <p className="text-lg text-gray-600 mb-8 font-montserrat">
                Our skilled seamstresses provide expert alterations, repairs, and custom work for all types of garments. 
                From simple hemming to complex alterations, we handle it all with precision and care.
              </p>
